...
public class NL_Checkout {
    ...
    public String nganluong_url = "https://www.nganluong.vn/checkout.php";
     public String merchant_site_code = "61228";	//thay mã merchant site mà b?n dã dang ký vào dây
     public String secure_pass = "d56819412cd0906c7d95f44c215d1b2d";	//thay m?t kh?u giao ti?p gi?a website c?a b?n v?i NgânLu?ng.vn mà b?n dã dang ký vào dây
